...
const QuranicArabicCourse = () => {
 ...
 <head>
  ...
  <link rel="canonical" href="https://ilmulquran.com/quranic-arabic-course/" />
  ...
  <title>Quranic Arabic Course – Understand Quran Word by Word</title>
  
  {/* Primary Meta Tags */}
  <meta name="description" content="Master Quranic Arabic online with certified teachers. Word-by-word Quran understanding, grammar breakdown & vocabulary building. Start free trial today!" />
  <meta name="keywords" content="Quranic Arabic Course, Learn Quranic Grammar, Understand Quran Word by Word, Online Arabic Classes, Quran Vocabulary Course, Islamic Studies, Quran Translation Course" />
  ...
  <meta property="og:url" content="https://ilmulquran.com/quranic-arabic-course/" />
  <meta property="og:title" content="Master Quranic Arabic: Understand Quran Directly | IlmulQuran" />
  <meta property="og:description" content="3-Month Intensive Course: Learn Arabic grammar & vocabulary directly from the Quran with male/female teachers. Get certification & lifetime access to materials." />
  <meta property="og:image" content="/Images/Courses/quranic-arabic-course.png" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta property="og:image:alt" content="Student learning Quranic Arabic with online teacher" />

  {/* Twitter */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="@ilmulquran" />
  <meta name="twitter:title" content="Quranic Arabic Course: Read Quran Without Translation" />
  <meta name="twitter:description" content="Join 5000+ students who understand Quran directly. Interactive lessons, progress tracking, and certification. Free placement test available!" />
  <meta name="twitter:image" content="/Images/Courses/quranic-arabic-course.png" />
  ...
  <Script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        description: "Comprehensive online course teaching Quranic Arabic grammar, vocabulary, and syntax using direct Quranic examples. Designed for English-speaking students.",
        provider: {
  ...
  {/* Windows Specific */}
  <meta name="msapplication-TileImage" content="/Images/Courses/quranic-arabic-course.png" />
