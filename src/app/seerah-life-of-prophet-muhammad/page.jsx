...
<div className="w-full lg:w-2/3 order-2 lg:order-1">
        <div className="bg-white rounded-xl shadow-xl p-8">
          <h1 className="text-center text-4xl font-bold text-[#003366] mb-8">
            Seerah of Prophet Muhammad (PBUH) - Online Course
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
            <div className="order-2 md:order-1">
              <p className="text-lg text-gray-700 mb-6">
                ...
                combining <Link href="/islamic-history" className="text-blue-600 underline">Islamic history</Link> 
                {"     "}studies with practical life lessons.
              </p>
              ...
              {[
                {
                  ...
                  content: "Understanding the Jahiliyyah period and social conditions"
                },
                {
                  title: "Prophetic Timeline",
                  content: "Birth to prophethood, Mecca period, Medina era"
                },
                {
                  title: "Major Events",
                  content: "Hijrah, Battles of Badr/Uhud/Khandaq, Treaty of Hudaybiyyah"
                },
                {
                  title: "Leadership Studies",
                  content: "Political and social reforms established by the Prophet"
                },
                {
                  title: "Character Analysis",
                  content: "Study of the Prophet's manners and relationships"
                },
                {
                  title: "Legacy & Impact",
                  content: "Influence on Islamic civilization and modern world"
                }
              ].map((module, index) => (
          ...
          <ul className="list-disc ml-8 space-y-2 pt-3">
            <li>Learn the Prophet’s Biography: Understand the major events in the life of the Prophet Muhammad (PBUH).</li>
            <li>Study His Teachings: Gain insights into the teachings and practices of the Prophet.</li>
            <li>Understand His Legacy: Learn about the impact of the Prophet’s life on Islam and the world.</li>
            <li>Improve Application: Apply the lessons from the Prophet’s life in your daily life.</li>
            <li>Gain Insight: Understand the historical context of the Prophet’s time.</li>
          </ul>
          ...
          <ul className="list-disc ml-8 space-y-2 pt-3">
            <li>Introduction to Seerah: Overview of the life of Prophet Muhammad (PBUH).</li>
            <li>Early Life: Understanding the early years of the Prophet.</li>
            <li>Prophethood: The beginning of the Prophet’s mission.</li>
            <li>Major Events: Key events during the Prophet’s life.</li>
            <li>Teachings of the Prophet: Study the Prophet’s teachings and practices.</li>
            <li>Migration to Medina: Understanding the significance of the Hijrah.</li>
            <li>Battles and Conflicts: Major battles and their impact.</li>
            <li>Final Years: The Prophet’s final years and legacy.</li>
          </ul>
