...
import StickyForm from "@/components/StickyForm"; // ✅ Added
...
const KidsIslamicClasses = () => {
  ...
  <head>
    ...
    {/* Open Graph Tags */}
    <meta property="og:title" content="Kids Islamic Classes Online (3-12 Yrs) | Quran & Sunnah Basics" />
    <meta
    ...
    />
    <meta property="og:image" content="https://ilmulquran.com/Images/Courses/islamic-classes-for-kids.png" />
    
    {/* Twitter Cards */}
    <meta name="twitter:title" content="Online Islamic School for Kids | Quran & Akhlaq Learning" />
    <meta
    ...
    <Script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "description": "Comprehensive Islamic education program for kids covering Quranic basics, Arabic literacy, and Prophetic values",
          "provider": {
            "@type": "Organization",
            "name": "ilmulQuran",
          ...
          <div className="w-full lg:w-3/4">
            ...
            <div className="bg-gray-100 rounded-lg shadow-lg p-8">
                ...
                <div className="w-full lg:w-1/2">
                  <p className="text-base text-gray-700 leading-relaxed">
                    ...
                    <p className="mt-4">
                      ...
                      <Link href="/learn-noorani-qaida-online" className="text-blue-600 underline hover:text-blue-800">
                        Quran basics
                      </Link>
                      , starting with Noorani Qaida to learn Arabic letters and proper Quran recitation. They also enjoy learning from{" "}
                      <Link href="/stories-of-the-prophets" className="text-blue-600 underline hover:text-blue-800">
                        Prophet’s stories
                      </Link>
              ...
              <ul className="list-disc ml-8 text-gray-700 space-y-3 pt-4">
                <li><Link href="/learn-arabic-online" className="text-blue-600">Arabic Alphabets</Link> through interactive games</li>
                <li><Link href="/learn-daily-supplication-online" className="text-blue-600">Daily Duas</Link> & Kalimahs with meanings</li>
                <li><Link href="/learn-pillars-of-islam" className="text-blue-600">Salah basics</Link> & Wudu steps</li>
                <li>Islamic manners from <Link href="/40-short-hadiths-for-kids" className="text-blue-600">Hadith for kids</Link></li>
              </ul>

              {/* Teaching Team */}
              <h2 className="text-2xl md:text-3xl pt-10 font-bold text-[#003366]">👩🏫 Teaching Team</h2>
              <ul className="list-disc ml-8 text-gray-700 space-y-3 pt-4">
                <li>Certified <Link href="/female-quran-teacher" className="text-blue-600">female teachers</Link> for young students</li>
                <li><Link href="/male-quran-teacher" className="text-blue-600">Male instructors</Link> for older boys</li>
                <li>Specialists in <Link href="/raising-little-mumins" className="text-blue-600">child Islamic education</Link></li>
              </ul>

              {/* Our Teachers */}
              <h2 className="text-2xl md:text-3xl pt-10 font-bold text-[#003366]">👩‍🏫 Our Teachers</h2>
              <ul className="list-disc ml-8 text-gray-700 space-y-3 pt-4">
                <li>Qualified <Link href="/quran-teachers" className="text-blue-600 hover:underline">male and female teachers</Link> with experience in early childhood Islamic education</li>
              ...
              <ul className="list-disc ml-8 text-gray-700 space-y-3 pt-3">
                <li><Link href="/40-short-hadiths-for-kids" className="text-blue-600">Hadith Memorization for Kids</Link></li>
                <li><Link href="/stories-of-the-prophets" className="text-blue-600">Prophets Stories Course</Link></li>
                <li><Link href="/raising-little-mumins" className="text-blue-600">Islamic Parenting Resources</Link></li>
              </ul>

              {/* Related Courses */}
              <h2 className="text-2xl md:text-3xl pt-10 font-bold text-[#003366]">🔗 Related Courses</h2>
              <ul className="list-disc ml-8 text-gray-700 space-y-3 pt-3">
                <li><Link href="/learn-noorani-qaida-online" className="text-blue-600 hover:underline">Learn Noorani Qaida Online</Link></li>
                <li><Link href="/taleem-ul-islam" className="text-blue-600 hover:underline">Taleem ul Islam</Link></li>
                <li><Link href="/quran-classes-for-beginners" className="text-blue-600 hover:underline">Quran Classes for Beginners</Link></li>
              </ul>
