...
<div className="w-full lg:w-2/3 order-2 lg:order-1">   
        <div className="bg-gray-100 rounded-lg  p-8">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="w-full lg:w-1/2">
              ...
              <ul className="list-disc ml-8 space-y-2 pt-3">
                <li>
                  <span className="font-bold text-[#1a73e8]">Certified Instructors:</span> Learn from  graduates with 10+ years experience
                </li>
                <li>
                  <span className="font-bold text-[#1a73e8]">Flexible Scheduling:</span> 24/7 class availability across time zones
                </li>
                <li>
                  <span className="font-bold text-[#1a73e8]">Practical Toolkit:</span> Includes Ramadan planner, dua booklet, and recipe guide
                </li>
              </ul>
            </div>
          ...
          <div className="mt-8">
            <h3 className="text-xl font-bold text-[#003366] mb-4">Recommended Next Steps</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/islamic-history" className="p-4 border rounded-lg hover:bg-gray-50">
                <h4 className="font-bold text-blue-600">After Ramadan:</h4>
                <p>Continue your journey with our <span className="font-semibold">Islamic History Certification</span></p>
              </Link>
              <Link href="/learn-daily-supplication-online" className="p-4 border rounded-lg hover:bg-gray-50">
                <h4 className="font-bold text-blue-600">Daily Practice:</h4>
                <p>Master essential duas with our <span className="font-semibold">Supplication Course</span></p>
              </Link>
            </div>
          </div>
          </div>
          ...
          <ul className="list-disc ml-8 space-y-2 pt-3">
            <li>Introduction to Ramadan: Overview of the significance of Ramadan.</li>
            <li>Fasting (Sawm): Understanding the rules and benefits of fasting.</li>
            <li>Taraweeh Prayers: Learn about the special night prayers during Ramadan.</li>
            <li>Quran Recitation: Techniques to enhance your Quran recitation during Ramadan.</li>
            <li>Charity (Zakat and Sadaqah): Understanding the importance of giving during Ramadan.</li>
            <li>Laylat al-Qadr: Study the significance of the Night of Decree.</li>
            <li>Eid al-Fitr: Understanding the celebration of Eid after Ramadan.</li>
          </ul>
