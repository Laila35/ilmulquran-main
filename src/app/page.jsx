...
const SpecialClasses = dynamic(() => import("../components/SpecialClasses"), {
  loading: () => <LoadingSpinner height="400px" />,
});
const Register = dynamic(() => import("../components/landingPage/Register"), {
  loading: () => <LoadingSpinner height="400px" />,
});
const ServiceHighlights = dynamic(() => import("../components/review"), {
...
// Dynamically import only needed icons
const FaBook = dynamic(() =>
  import("react-icons/fa").then((mod) => mod.FaBook)
);
const FaRegCheckCircle = dynamic(() =>
  import("react-icons/fa").then((mod) => mod.FaRegCheckCircle)
);
const FaRegComment = dynamic(() =>
  import("react-icons/fa").then((mod) => mod.FaRegComment)
);
const FaLanguage = dynamic(() =>
  import("react-icons/fa").then((mod) => mod.FaLanguage)
);
const FaGlobe = dynamic(() =>
  import("react-icons/fa").then((mod) => mod.FaGlobe)
);
const FaBookOpen = dynamic(() =>
  import("react-icons/fa").then((mod) => mod.FaBookOpen)
);
...
const services = [
  {
    ...
    description: "Master Quranic recitation with Tajweed in personalized sessions.",
  },
  {
    icon: <FaRegCheckCircle className="text-teal-600 text-3xl" />,
    title: "Quran Memorization",
    description: "Achieve Quran memorization goals with our skilled mentors.",
  },
  {
    icon: <FaRegComment className="text-teal-600 text-3xl" />,
    title: "Tafsir and Translation",
    description: "Gain deep insight into Quranic text with detailed Tafsir and translation.",
  },
  {
    icon: <FaLanguage className="text-teal-600 text-3xl" />,
    title: "Islamic Studies",
    description: "Learn various Islamic sciences to enrich your faith.",
  },
  {
    icon: <FaGlobe className="text-teal-600 text-3xl" />,
    title: "Arabic Language",
    description: "Enhance Quranic understanding by learning Quranic Arabic.",
  },
  {
    icon: <FaBookOpen className="text-teal-600 text-3xl" />,
    title: "Learn Ten Qirat Online",
    description: "Master different styles of Quranic recitation with expert guidance.",
  },
];
...
export default function Home() {
  const [visibleSections, setVisibleSections] = useState({
    ...
    courses: false,
    testimonials: false,
    specialClasses: true, // Always load hero section
  });
  ...
  <link
    rel="preload"
    as="image"
    href="/Images/Logo/updated-logo.webp"
    fetchPriority="high"
  />
  ...
  <meta
    property="og:title"
    content="Learn Quran Online â€“ Interactive Classes with Certified Tutors | ilmulQuran"
  />
  <meta
    property="og:description"
    content="Join expert-led Online Quran Classes at ilmulQuran. Learn Tajweed, Quran recitation, and memorization with flexible scheduling. Get a free trial now!"
  />
  <meta
    property="og:url"
    content="https://ilmulquran.com"
  />
  <meta property="og:site_name" content="ilmulQuran" />
  <meta
    property="og:image"
    content="https://ilmulquran.com/Images/Logo/updated-logo.webp"
  />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta
    property="og:image:alt"
    content="Child and tutor in Quran class online with open Mushaf"
  />
  ...
  <meta
    name="twitter:title"
    content="Online Quran Classes with Expert Tutors | ilmulQuran"
  />
  <meta
    name="twitter:description"
    content="Enroll in online Quran classes with male & female teachers. Tajweed, memorization & more. Personalized lessons + free trial!"
  />
  <meta
    name="twitter:image"
    content="https://ilmulquran.com/Images/Logo/updated-logo.webp"
...
<Script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "Course",
      name: "Online Quran Classes â€“ Learn with Tajweed & Islamic Studies",
      description:
        "Personalized Quran learning experience online for all ages. Courses include Tajweed, Quran memorization, and Islamic studies with qualified teachers at ilmulQuran Academy.",
      provider: {
        "@type": "EducationalOrganization",
        name: "ilmulQuran",
        sameAs: "https://ilmulquran.com",
        description:
          "A trusted online Islamic education platform offering structured Quran learning programs with certified male and female tutors.",
      },
      url: "https://ilmulquran.com",
      image:
        "https://ilmulquran.com/Images/Logo/updated-logo.webp",
...
<section className=" px-4 py-12 ">
  ...
  {visibleSections.courses && (
    <div className="flex flex-wrap justify-center gap-6">
      ...
      {/* Steps to Learn Quran */}
      <section>
        <Steps stepsData={stepsData} />
      </section>

      {/* Discount Banner and Fee Plan */}
