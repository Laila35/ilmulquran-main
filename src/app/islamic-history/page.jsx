...
import StickyForm from "@/components/StickyForm"; // Make sure you have this component
            ...
            <div className="bg-gray-100 rounded-lg shadow-lg p-8">
              ...
              <div className="flex flex-col lg:flex-row gap-4">
                <div className="w-full lg:w-1/2 order-2 lg:order-1">
                  ...
                  <h3
                    id="why-choose"
                    className="text-xl md:text-2xl font-bold text-[#003366] pt-3"
                  >
                    Why Choose Our History Course?
                  </h3>
                  <ul className="list-disc ml-8 space-y-2 pt-3">
                    <li>
                      <span className="font-bold text-[#1a73e8]">Expert Analysis:</span> Study
                      primary sources and{" "}
                    ...
                    <li>
                      <span className="font-bold text-[#1a73e8]">Comprehensive Curriculum:</span>{" "}
                      From{" "}
              ...
              <h2
                id="overview"
                className="text-2xl md:text-3xl pt-6 font-bold text-[#003366]"
              >
                Course Highlights
              </h2>
              <ul className="list-disc ml-8 space-y-2 pt-3">
              ...
              <h3
                id="curriculum"
                className="text-xl md:text-2xl font-bold text-[#003366] pt-6"
              >
                Detailed Curriculum
              </h3>
              <ul className="list-disc ml-8 space-y-2 pt-3">
              ...
              <div id="related" className="mt-8 border-t pt-6">
                ...
                <ul className="list-disc ml-8 space-y-2 pt-3">
                  ...
                  <li>
                    <Link
                      href="/companions-of-prophet-muhammad"
