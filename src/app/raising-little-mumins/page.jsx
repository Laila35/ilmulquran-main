    ...
    <>
      <head>
        ...
        <link
          rel="preload"
          as="image"
          href="/Images/Courses/little-mumins-course.png"
          fetchPriority="high"
        />
        ...
        <meta
          name="description"
          content="Certified online Islamic tarbiyah course for ages 4-7: Quran basics, Salah training, Islamic manners & prophet's stories with expert teachers. Free trial available."
        />
        <meta
          name="keywords"
          content="Islamic kids course, Muslim children education, Quran for kindergarten, Islamic manners class, Prophet stories for kids, Muslim parenting course"
        />
...
<div className="w-full lg:w-2/3 order-2 lg:order-1"> 
        <div className="bg-gray-100 rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <ul className="space-y-3">
                <li>
                  <strong>Quran Foundations:</strong> Short surahs with basic tajweed
                </li>
                <li>
                  <strong>Salah Training:</strong> Step-by-step prayer guidance
                </li>
                <li>
                  <strong>Islamic Manners:</strong> 40+ daily life scenarios
                </li>
                <li>
                  <strong>Prophet Stories:</strong> 12 inspirational seerah lessons
                </li>
              </ul>
            </div>
          ...
          <h2 className="text-2xl font-bold text-[#003366] mt-12">Parent Experiences</h2>
          <TestimonialComponent testimonialsData={testimonialsData} />

      

          <h2 className="text-2xl font-bold text-[#003366] mt-12">Related Courses</h2>
          <div className="grid md:grid-cols-2 gap-4 mt-6">
            <Link href="/islamic-classes-for-kids" className="p-4 border rounded-lg hover:bg-gray-50">
              <h3 className="text-lg font-semibold text-[#1a73e8]">Advanced Islamic Studies</h3>
              <p>For ages 8-12 years</p>
            </Link>
            <Link href="/learn-noorani-qaida-online" className="p-4 border rounded-lg hover:bg-gray-50">
              <h3 className="text-lg font-semibold text-[#1a73e8]">Quran Reading Basics</h3>
              <p>Noorani Qaida Course</p>
            </Link>
          </div>
          ...
          <ul className="list-disc ml-8 text-gray-700 space-y-2 pt-3">
            <li>
              ...
              Who is Allah? Tawheed and the Pillars of Islam, Introduction to Prophet Muhammad ﷺ
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Quran Learning:
              </span>{" "}
              Short Surahs (Ikhlas, Falaq, Naas, Kawthar), Word-by-word basic meanings, Tajweed introduction for kids
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Dua Learning:
              </span>{" "}
              Before sleeping, waking, eating, entering/leaving, With actions and real-life examples, Weekly memorization & practice
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Salah Basics:
              </span>{" "}
              Names & timings of 5 daily prayers, Step-by-step Salah introduction, Wudu awareness and cleanliness
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Akhlaaq & Adaab:
              </span>{" "}
              Saying Salaam, thanking, seeking permission, Respecting parents, guests, teachers, Helping others & table manners
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Teachings of Prophet Muhammad ﷺ:
              </span>{" "}
              Stories of kindness, honesty, and love, Simple Seerah moments for kids, Practice Sunnah in daily actions
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Hadith for Kids:
              </span>{" "}
              1 short Hadith per week, With meaning and action plan, "Live the Hadith" activity each week
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Islamic History (Basics):
              </span>{" "}
              Makkah & Madinah, Important moments: Hijrah, first revelation, Sahaba examples: Abu Bakr (RA), Umar (RA)
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Pillars of Worship:
              </span>{" "}
              What is fasting? What is charity? Simple intro to Hajj & Zakat
            </li>
            <li>
              <span className="font-semibold text-[#1a73e8]">
                Islamic Calendar Awareness:
              </span>{" "}
              12 Islamic months, Special months: Ramadan, Dhul Hijjah, Muharram, Eid & Islamic events
            </li>
          </ul>
          ...
          <p className="text-base text-gray-700 leading-relaxed pt-3">
            Children receive a Digital Certificate of Completion at the end of the course.
          </p>
    ...
    <div className="mt-12 bg-[#003366] text-white p-8 rounded-2xl text-center">
          ...
          <p className="text-base text-gray-700 leading-relaxed pt-4">
            Give your child the gift of Islamic knowledge and manners.{" "}
            <Link href="/get-register" className="text-blue-600 no-underline">
              📲 Book your free trial class and begin their Tarbiyah journey today.
            </Link>
          </p>
